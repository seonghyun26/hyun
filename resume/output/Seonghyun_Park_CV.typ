...
#let connections-list = (
  [#fa-icon("location-dot", size: 0.9em) #h(0.05cm)Seoul, South Korea],
  [#box(original-link("mailto:hyun26@kaist.ac.kr")[#fa-icon("envelope", size: 0.9em) #h(0.05cm)hyun26\@kaist.ac.kr])],
  [#box(original-link("tel:+82-10-6869-1033")[#fa-icon("phone", size: 0.9em) #h(0.05cm)010-6869-1033])],
  [#box(original-link("https://seonghyun26.github.io/hyun/")[#fa-icon("link", size: 0.9em) #h(0.05cm)seonghyun26.github.io\/hyun])],
  [#box(original-link("https://linkedin.com/in/shpark26")[#fa-icon("linkedin", size: 0.9em) #h(0.05cm)shpark26])],
  [#box(original-link("https://github.com/seonghyun26")[#fa-icon("github", size: 0.9em) #h(0.05cm)seonghyun26])],
  [#box(original-link("https://scholar.google.com/citations?user=w4q4N9sAAAAJ")[#fa-icon("graduation-cap", size: 0.9em) #h(0.05cm)Google Scholar])],
)
